...
class Ballon(pygame.sprite.Sprite):
    def __init__(self, speed):
        ...
        self.surf = pygame.image.load("sprite/ballon_very_small.jpg").convert()
...
while running:
    ...
    if args.pose:
        if len(poses)>0:
            ...
            for seg in data['segments'].values():
                ...
                pygame.draw.line(screen, line_color, pt1, pt2)
            # pose = poses[0]
   ...
   # print(f"poses shape {poses[0].shape}") 17,3
    ...
    for hand in hands:
        hit_ballon =  pygame.sprite.spritecollideany(hand, ballons)
        if hit_ballon:
